...
В подкаталоге example каталога установки dbframework находится пример программы с использованием dbframework. В подкаталоге docs каталога установки dbframework находится подробное описание классов, входящих в dbframework.